...
Route::resource('admin/riwayat', RiwayatadminController::class);
Route::delete('/riwayat/hapusharian', [RiwayatadminController::class, 'hapusHarian'])->name('riwayat.hapusharian');
Route::get('/riwayat/tampilan', [RiwayatadminController::class, 'index'])->name('riwayat.tampilan');
Route::post('/admin/approveRejectPesanan/{id}', [RiwayatadminController::class, 'approveRejectPesanan'])->name('admin.approveRejectPesanan');
